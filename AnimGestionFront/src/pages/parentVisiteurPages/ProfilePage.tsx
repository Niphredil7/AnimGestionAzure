...
export default function PageProfile() {
  ...
  const { children, selectedChild, setChildren, selectChild } = childrenStore();
  ...
  const {
    ...
    error: childrenError,
  } = childService.getChildByParent(userId, isParent);
  ...
  const childToShow = selectedChild ?? children[0] ?? null;
          ...
          <>
            ...
            {childToShow ? (
              <ParentPlanning
                ...
                childName={childToShow.firstName}
                classId={childToShow.classId}
              />
            ) : (
