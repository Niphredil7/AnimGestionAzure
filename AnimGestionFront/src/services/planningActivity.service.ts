...
class PlanningActivityService {
   ...
   public createPlanningActivity(): UseMutationResult<
  IPlanningActivityResponse,
  Error,
  IPlanningActivityData
> {
  return useMutation<IPlanningActivityResponse, Error, IPlanningActivityData>({
    mutationKey: ["createPlanning"],
    mutationFn: async (data) =>
      planningActivityApi.createPlanningActivity(data),
  });
}
